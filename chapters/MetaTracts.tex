...
\begin{figure}[h]
\centering
%	\subfloat[]{\includegraphics[width=0.49\linewidth]{imagesMT2014/MT_crop16_MT_2.png}}
	\subfloat[]{\includegraphics[width=0.49\linewidth]{imagesMT2014/MT_crop16_MT_2.PNG}} 
	\subfloat[]{\includegraphics[width=0.49\linewidth]{imagesMT2014/length_distribution.PNG}}\\
%	\subfloat[]{\includegraphics[width=0.9\linewidth]{imagesMT2014/mt_crop_16_orient.PNG}}
...
\begin{figure}[h]
  \centering
   \includegraphics[width=0.9\linewidth]{imagesMT2014/mesh.png}
   \caption{Extracted meshes. (A) shows two of the extracted meshes separately. (B) Shows two different views of the combined meshes.}
   \label{fig:mesh}
   \end{figure}
\begin{figure}
\centering
...
\centering
	...
	%\includegraphics[width=0.23\textwidth]{imagesMT2014/Graph_crop16_3.PNG}
