...
\begin{figure}[hb]
	\centering
	\includegraphics[width=0.45\linewidth]{images_pvis/comparison_all.pdf}
	\caption{Applying only hierarchical (a) and K-means (b) clustering methods of MetaTracts for various numbers of clusters.}
...
\centering
	...
	\includegraphics[width=0.45\linewidth]{images_pvis/dataset2.pdf}
