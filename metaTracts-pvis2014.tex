...
The presented work contributes to the state of the art of CFRP characterization by the introduction of MetaTracts, a technique for extracting and visualizing fiber bundles and the geometric structure of the weaving pattern in fiber reinforced composites scanned with X-ray computed tomography. 
The declared goal of this work is to analyze large areas of CFRPs using XCT scans of low resolution, in which individual fibers are barely visible. 
...
We evaluate our algorithm on a number of datasets and demonstrate that MetaTracts effectively and robustly identifies and separates different fiber bundles. 
